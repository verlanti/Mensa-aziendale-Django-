  $(document).ready(function(){
    $('#id_password1').keyup(updateCount);
    $('#id_password1').keydown(updateCount);

    $('#id_password2').keyup(updateCount2);
    $('#id_password2').keydown(updateCount2);
  ...
  function checkpassword() {
      ...
      var len_pass1 = $('#id_password1').val().length;
